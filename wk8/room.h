...
private:
	...
	// refers to which room it goes too. 
	int north;
	int south;
	int east;
	int west;
...
public:
	Room(){};
	Room::Room(string name, string roomDescription, int id, int north, int south, int east, int west, int up, int down, bool indoor, bool dark);
	~Room(){};
