...
int main()
{
	...
	Item item6 = Item("turkey sandwich", "It's a delicious turkey sandwich","turkey sandwich", 6, 0, 1, true, false, true);
	Item item7 = Item("skeleton key", "It's looks like you could unlock something with this", "Thing that unlocks stuff", 7, 0, 1, true, false, true);

	item1.addKeyword("flashlight");
	item2.addKeyword("book");
	item3.addKeyword("candle");
	item4.addKeyword("robe");
	item5.addKeyword("brick");
	item6.addKeyword("sandwich");
	item7.addKeyword("key");
	...
	itemStorage.push_back(item6);
	itemStorage.push_back(item7);
